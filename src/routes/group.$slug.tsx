...
export const Route = createFileRoute("/group/$slug")({
  head: ({ params }) => {
    ...
    const desc = g ? `Browse ${g.name} categories and start practicing MCQs.` : "Browse MCQ categories.";
    return {
      meta: [
        { title },
...
function GroupPage() {
  ...
  return (
    <PageShell>
      <div className="mb-6">
        <div className="text-xs text-muted-foreground uppercase tracking-wide">Group</div>
